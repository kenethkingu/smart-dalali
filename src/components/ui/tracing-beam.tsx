        ...
        >
          ...
          <defs>
            <motion.linearGradient
              ...
              y2={y2}
            >
              <stop stopColor="var(--pl-accent)" stopOpacity="0"></stop>
              <stop stopColor="var(--pl-accent)"></stop>
              <stop offset="0.325" stopColor="var(--pl-accent)"></stop>
              <stop offset="1" stopColor="var(--pl-accent)" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
